# Using PowerShell to Create a Windows Server Custom Image using Azure Image Builder (AIB) and Shared Image Gallery (SIG)
...
$templateUrl="https://raw.githubusercontent.com/jdmsft/AzureImageBuilder/master/Template/CreateWinImageToSIG.json"
